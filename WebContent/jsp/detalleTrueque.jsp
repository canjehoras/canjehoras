		...
		<div class="container" >
			<div class="service_block" style="margin: 10px;">
				...
				<div class="textoTrueque">
					...
					<p class="animated fadeInDown wow"><fmt:message key="listado.ofrezco"/> ${trueque.descripcionOferta}</p>
					<c:if test="${trueque.descripcionDemanda != ''}">
						<p class="animated fadeInDown wow"><fmt:message key="listado.busco"/>${trueque.descripcionDemanda}</p>
					</c:if>
