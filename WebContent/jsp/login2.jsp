...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="login.html" method="post" commandName="LoginForm">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input cssClass="m-wrap placeholder-no-fix"  path="correoElectronico"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input cssClass="m-wrap placeholder-no-fix" type="password" path="pass"/>
					</div>
				</div>
			</div>
